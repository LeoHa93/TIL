...
public class MainActivity extends AppCompatActivity {
    ...
    BroadcastReceiver broadcastReceiver;    //통신에 대해 수신하는 역할
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(cmd.equals("android.net.conn.CONNECTIVITY_CHANGE")){
                    ...
                    if(mobile!= null && mobile.isConnected()){
                        ...
                        imageView.setImageResource(R.drawable.wifinot);
                    }
    ...
    public void ckbt(View v){
        if(v.getId() == R.id.button){
            ...
            if(check == PackageManager.PERMISSION_GRANTED){
                Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:010-1234-5667"));
                startActivity(intent);
            }else{
                Toast.makeText(this, "DENIED", Toast.LENGTH_SHORT).show();
            }
        }else if(v.getId() == R.id.button2){
            int check = PermissionChecker.checkSelfPermission(this, Manifest.permission.SEND_SMS);
            if(check == PackageManager.PERMISSION_GRANTED){
                SmsManager smsManager = SmsManager.getDefault();
                smsManager.sendTextMessage("tel:010-9876-5432", null, "WASSAP", null, null);
